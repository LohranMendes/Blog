                    ...
                    <div x-data="{open: false}" class="lg:inline hidden">
                        <button x-on:click="open =! open" class="inline-flex"> 
                            <span class="mr-1 font_header"> 
                                <i class="bi bi-person-circle h-20"></i> {{ $usuario['usuario'] }}
                            </span> 
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute z-10 right-12 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul class="py-1 text-sm text-gray-800">
                                <li> 
                                    <a href="{{route('perfil', ['usuario' => $usuario['usuario']])}}" class="mt-1 block px-4 py-1 rounded-sm hover:bg-gray-100"> Perfil </a> 
                                </li>
                    ...
                    <div class="lg:hidden" x-data="{sidebar: false}">
                        ...
                        <div x-show="sidebar" @click.away="siderbar = false" class="g:hidden fixed esmeralda inset-0 bg-opacity-85">
                            <ul class="py-1 text-sm text-white">
                                ...
                                <li> 
                                    <a href="{{route('perfil', ['usuario' => $usuario['usuario']])}}" class="mt-1 block px-4 py-1 rounded-sm hover:bg-gray-800"> Perfil </a> 
                                </li>
                                <li> 
                                    <a href="#" class="block px-4 py-1 rounded-sm hover:bg-gray-800"> Configurações </a>
                                </li>
                                <li> 
                                    <a href="#" class="mb-1 block px-4 py-1 rounded-sm hover:bg-gray-800"> Deslogar </a>
                                </li>
                            </ul>
                        </div>
                    </div>
